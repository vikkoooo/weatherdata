...
public class WeatherDataUI
{
	...
	/**
	 * Query user for two dates and present the average temperature for all dates in
	 * the period, sorted by date (ascending).
	 */
	...
	/**
	 * Query user for two dates and present the dates within the period where there
	 * are missing values, sorted by number of missing values (descending).
	 */
